...
const Schemes = () => {
  ...
  // Construct backend proxy URL so government API credentials stay server-side.
  const getApiUrl = (offset) => {
    const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || "http://localhost:8000"
    return `${API_BASE_URL}/blog/government-schemes/?offset=${offset}&limit=${itemsPerPage}`
  }
