            ...
            <div className="md:w-1/3 p-6">
              <div className="aspect-square overflow-hidden rounded-lg">
                {artist.profile_image ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-orange-100 via-amber-100 to-teal-100 flex items-center justify-center text-5xl font-bold text-orange-700">
                  ...
                  {artist.portfolio_items.map((work, index) => (
                    ...
                    >
                      {work.thumbnail ? (
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-orange-100 via-amber-100 to-teal-100 flex items-center justify-center text-xs font-semibold text-orange-700">
                          Media pending
                        </div>
                      )}
                    </div>
