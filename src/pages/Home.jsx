              ...
              {featuredArtists.map((artist) => (
                <Link to={`/artists/${artist.id}`} key={artist.id} className="card group">
                  <div className="aspect-square overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-br from-orange-100 via-amber-100 to-teal-100 flex items-center justify-center text-4xl font-bold text-orange-700 group-hover:scale-105 transition-transform duration-300">
                ...
                <div key={course.id} className="card group">
                  <div className="aspect-video overflow-hidden">
                    {getCourseImage(course) ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-orange-100 via-amber-100 to-teal-100 flex items-center justify-center text-sm font-semibold text-orange-700">
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="w-full max-w-[300px] aspect-square rounded-lg shadow-lg bg-green-100 text-green-700 flex items-center justify-center text-5xl font-bold">
                WA
              </div>
            </div>
          </div>
      ...
      <section className="py-12">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-8">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="w-full max-w-[300px] aspect-square rounded-lg shadow-lg bg-orange-100 text-orange-700 flex items-center justify-center text-5xl font-bold">
                AI
              </div>
            </div>
          </div>
